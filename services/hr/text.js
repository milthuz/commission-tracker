...
const OFFER_CLAUSES = [
  ...
  ['13. Termination.', 'You may, at any time, terminate this agreement for any reason whatsoever by giving Cluster written notice at least {noticeWeeks} weeks before the date of such termination. You may not, however, take vacation leave during this notice period without Cluster’s written consent. Cluster reserves the right to waive this notice, either in whole or in part.'],
...
const OFFER_CLAUSES_FR = [
  ...
  ['13. Fin d’emploi.', 'Vous pouvez, en tout temps, mettre fin au présent contrat pour quelque motif que ce soit en donnant à Cluster un préavis écrit d’au moins {noticeWeeks} semaines avant la date de cette fin d’emploi. Vous ne pouvez toutefois pas prendre de vacances pendant cette période de préavis sans le consentement écrit de Cluster. Cluster se réserve le droit de renoncer à ce préavis, en tout ou en partie.'],
...
// Préavis de démission (clause 13) en toutes lettres, comme le gabarit l'écrivait (« four weeks »).
// Le gabarit disait quatre semaines ; la valeur par défaut est passée à deux (demande des RH,
// 2026-09-23) et se règle maintenant par dossier.
const WORDS = {
...
const inWords = (n, lang) => (WORDS[lang] && WORDS[lang][n] !== undefined ? WORDS[lang][n] : String(n));
...
module.exports = { inWords, OFFER, OFFER_CLAUSES, OFFER_INTRO, OFFER_CLOSING, OFFER_ACK, offerSalaryExtra, AGREEMENT };
